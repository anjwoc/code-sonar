...
이 스킬은 단일 프로젝트 또는 멀티 프로젝트 분석 결과에서 **데이터베이스 스키마 + ERD + 크로스서비스 엔티티 관계 다이어그램**을 생성하는 파이프라인입니다.
...
### Phase 3 — ENTITY-RELATIONSHIP Index 연결

`{output_dir}/Index.md` 에 ENTITY-RELATIONSHIP.md 링크와 섹션을 추가한다:
...
| [{project}/Database & Schema.md](./{project}/Database%20%26%20Schema.md) | {project} DB 스키마 + ERD |
```

---

### Phase 4 — Evidence 및 QA
