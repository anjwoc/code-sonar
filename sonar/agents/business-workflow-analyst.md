...
- `${SONAR_OUTPUT_DIR}/resources/wiki/`
- `${SONAR_OUTPUT_DIR}/_evidence/01. Evidence Ledger.md`

## 출력

- `_business/01. Business Workflow.md`
- `_business/02. Scenarios.md`
- `_business/03. Cross Project Traceability.md`
